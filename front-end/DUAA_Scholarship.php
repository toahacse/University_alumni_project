...
<div class="row mt-3">
    ...
    <div class="col-md-9">
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-4 m-0 p-0"><h3 class="p-2 text-light" style="background-color: #0c5460;font-size: 30px;text-align: center;">DUAA Scholarship</h3></div>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
        ...
        $select1 = $con1->prepare("SELECT * FROM scholarship WHERE publication_status=1 AND content ='Sub Content' ORDER BY id DESC limit 6");
