...
<div class="row mt-3">
    ...
    <div class="col-md-9">
        <div class="row">
            <div class="col-md-12">
                <div class="col-md-2 m-0 p-0"><h3 class="p-2 text-light" style="background-color: #00a946;font-size: 30px;text-align: center;">News</h3></div>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-12">
        ...
        try {
            ...
            $select1 = $con1->prepare("SELECT * FROM news WHERE publication_status=1 AND content ='Sub News' ORDER BY id DESC limit 6");
