...
if(isset($_POST['ok'])) {
    ...
    if($check) {
        if (file_exists($imageUrl)) {
            ...
            $query="INSERT INTO scholarship(title_name,short_description,long_description,img,content,publication_status)
            VALUES ('$title_name','$short_description','$long_description','$imageUrl','$content','$publication_status')";

            if(mysqli_query($db,$query)){
                $mass="<h3 class='text-success text-center'>"."Scholarship Save Successfully"."</h3>";
            }
        }
    }
}
        ...
        <div class="col-md-offset-1 col-md-8" style="margin-top: 30px;">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="text-center text-success">Add Scholarship</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-success btn-block" name="ok" value="Save Scholarship" />
                        </div>
                    </form>
                </div>
            </div>
