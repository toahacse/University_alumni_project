...
if(isset($_POST['ok'])) {
    ...
    $filetype=pathinfo($fileName, PATHINFO_EXTENSION);
        if($fileName){
            ...
            $query="UPDATE meeting SET title_name='$title_name',short_description='$short_description',long_description='$long_description',content='$content',
        ...
        <div class="col-md-offset-1 col-md-8" style="margin-top: 30px;">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="text-center text-success">Update Committee Meeting</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        try{
                            ...
                            $select=$con->prepare("SELECT * FROM meeting WHERE id='$id'");
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-success btn-block" name="ok" value="Update Committee Meeting" />
                        </div>
                    </form>
                </div>
            </div>
