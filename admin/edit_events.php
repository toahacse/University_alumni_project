...
if(isset($_POST['ok'])) {
    ...
    $filetype=pathinfo($fileName, PATHINFO_EXTENSION);
        if($fileName){
            ...
            $query="UPDATE events SET title_name='$title_name',short_description='$short_description',long_description='$long_description',content='$content',
        ...
        <div class="col-md-offset-1 col-md-8" style="margin-top: 30px;">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="text-center text-success">Update Events</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        try{
                            ...
                            $select=$con->prepare("SELECT * FROM events WHERE id='$id'");
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-success btn-block" name="ok" value="Update Events" />
                        </div>
                    </form>
                </div>
            </div>
