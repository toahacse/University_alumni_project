...
if(isset($_POST['ok'])) {
    ...
    $filetype=pathinfo($fileName, PATHINFO_EXTENSION);
        if($fileName){
            ...
            $query="UPDATE documents SET title_name='$title_name',short_description='$short_description',long_description='$long_description',content='$content',
                    img='$imageUrl',publication_status='$publication_status' WHERE id='$id'";
            if(mysqli_query($db,$query)){
                $mass="<h3 class='text-success text-center'>"."Committee Meeting Update Successfuly"."</h3>";
            }
        }else{
            $query="UPDATE documents SET title_name='$title_name',short_description='$short_description',long_description='$long_description',content='$content',
                    publication_status='$publication_status' WHERE id='$id'";
                if(mysqli_query($db,$query)){
                    $mass="<h3 class='text-success text-center'>"."Documents Update Successfuly"."</h3>";
                }
        }
}
?>
        ...
        <div class="col-md-offset-1 col-md-8" style="margin-top: 30px;">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="text-center text-success">Update Documents</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        try{
                            ...
                            $select=$con->prepare("SELECT * FROM documents WHERE id='$id'");
                        ...
                        <div class="form-group">
                            <input type="submit" class="btn btn-success btn-block" name="ok" value="Update Documents" />
                        </div>
                    </form>
                </div>
            </div>
